import {r as S, j as or, a as Vs} from "./index-CQoC5iON.js";
...
const ke = typeof window < "u"
  , lr = ke ? S.useLayoutEffect : S.useEffect
...
class Ne {
    ...
    add(e) {
        return Be(this.subscriptions, e),
...
const ks = t => e => e <= .5 ? t(2 * e) / 2 : (2 - t(2 * (1 - e))) / 2
  , Fs = t => e => 1 - t(1 - e)
  , Bs = kt(.33, 1.53, .69, .99)
  , Ue = Fs(Bs)
  , Is = ks(Ue)
  , Os = t => (t *= 2) < 1 ? .5 * Ue(t) : .5 * (2 - Math.pow(2, -10 * (t - 1)))
  ...
  , It = ["setup", "read", "resolveKeyframes", "preUpdate", "update", "preRender", "render", "postRender"];
function vr(t, e) {
    let n = new Set
      , s = new Set
      , i = !1
...
function Ws(t, e) {
    ...
    g), {})
      ...
      , v = () => {
        ...
        n = !1,
        X.useManualTiming || (i.delta = s ? 1e3 / 60 : Math.max(Math.min(g - i.timestamp, Tr), 1)),
        i.timestamp = g,
        i.isProcessing = !0,
        a.process(i),
        l.process(i),
...
const {schedule: V, cancel: q, state: k, steps: Zt} = Ws(typeof requestAnimationFrame < "u" ? requestAnimationFrame : $, !0);
let Nt;
function xr() {
    Nt = void 0
}
const O = {
    now: () => (Nt === void 0 && O.set(k.isProcessing || X.useManualTiming ? k.timestamp : performance.now()),
    Nt),
    set: t => {
        Nt = t,
        queueMicrotask(xr)
  ...
  , We = $s("--")
  , Pr = $s("var(--")
  , $e = t => Pr(t) ? Sr.test(t.split("/*")[0].trim()) : !1
...
const Ar = /^(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))$/iu
  , He = (t, e) => n => !!(typeof n == "string" && Ar.test(n) && n.startsWith(t) || e && !br(n) && Object.prototype.hasOwnProperty.call(n, e))
  , Gs = (t, e, n) => s => {
    if (typeof s != "string")
        return s;
  ...
  , nt = {
    ...
    transform: ({red: t, green: e, blue: n, alpha: s=1}) => "rgba(" + Jt.transform(t) + ", " + Jt.transform(e) + ", " + Jt.transform(n) + ", " + Pt(Ct.transform(s)) + ")"
};
function Vr(t) {
    let e = ""
      , n = ""
...
const fe = {
  ...
  , lt = {
    ...
    transform: ({hue: t, saturation: e, lightness: n, alpha: s=1}) => "hsla(" + Math.round(t) + ", " + _.transform(Pt(e)) + ", " + _.transform(Pt(n)) + ", " + Pt(Ct.transform(s)) + ")"
}
  , E = {
...
function Er(t) {
    return isNaN(t) && typeof t == "string" && (t.match(Ge)?.length || 0) + (t.match(Dr)?.length || 0) > 0
}
const Hs = "number"
  , _s = "color"
  , Rr = "var"
  , Lr = "var("
  , yn = "${}"
  , kr = /var\s*\(\s*--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)|#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\)|-?(?:\d+(?:\.\d+)?|\.\d+)/giu;
function Mt(t) {
    const e = t.toString()
      , n = []
      , s = {
      ...
      , i = [];
    let o = 0;
    const a = e.replace(kr, l => (E.test(l) ? (s.color.push(o),
    i.push(_s),
    n.push(E.parse(l))) : l.startsWith(Lr) ? (s.var.push(o),
    i.push(Rr),
...
function _e(t) {
    return typeof t == "number" ? Ur : typeof t == "string" ? $e(t) ? $t : E.test(t) ? Tn : $r : Array.isArray(t) ? Ys : typeof t == "object" ? E.test(t) ? Tn : Kr : $t
}
function Ys(t, e) {
    const n = [...t]
      , s = n.length
...
const $r = (t, e) => {
    const n = Z.createTransformer(e)
      , s = Mt(t)
      , i = Mt(e);
    return s.indexes.var.length === i.indexes.var.length && s.indexes.color.length === i.indexes.color.length && s.indexes.number.length >= i.indexes.number.length ? de.has(t) && !i.values.length || de.has(e) && !s.values.length ? Nr(t, e) : Lt(Ys(Wr(s, i), i.values), n) : $t(t, e)
}
;
function qs(t, e, n) {
...
const M = {
  ...
  , ee = .001;
function zr({duration: t=M.duration, bounce: e=M.bounce, velocity: n=M.velocity, mass: s=M.mass}) {
    let i, o, r = 1 - e;
    r = z(M.minDamping, M.maxDamping, r),
    t = z(M.minDuration, M.maxDuration, W(t)),
    r < 1 ? (i = c => {
        const u = c * r
          , h = u * t
          , f = u - n
...
function Ht(t=M.visualDuration, e=M.bounce) {
    ...
    const o = n.keyframes[0]
      ...
      , {stiffness: l, damping: c, mass: u, duration: h, velocity: f, isResolvedFromDuration: d} = Jr({
        ...n,
...
;
function pe({keyframes: t, velocity: e=0, power: n=.8, timeConstant: s=325, bounceDamping: i=10, bounceStiffness: o=500, modifyTarget: r, min: a, max: l, restDelta: c=.5, restSpeed: u}) {
    const h = t[0]
      , f = {
        done: !1,
        value: h
    ...
    return R(0),
    {
        ...
        next: b => {
            let I = !1;
            return !w && P === void 0 && (I = !0,
            A(b),
            R(b)),
            P !== void 0 && b >= P ? w.next(b - P) : (!I && A(b),
            f)
        }
    }
}
...
class qe extends Ye {
    ...
    initAnimation() {
        ...
        let {keyframes: a} = e;
        const l = n || St;
        l !== St && typeof a[0] != "number" && (this.mixKeyframes = Lt(ao, qs(a[0], a[1])),
        a = [0, 100]);
        const c = l({
            ...e,
            keyframes: a
    ...
    tick(e, n=!1) {
        ...
        return R && m !== pe && (P.value = Xe(u, this.options, y, this.speed)),
        v && v(P.value),
        R && this.finish(),
        P
    }
    ...
    set speed(e) {
        ...
        n && (this.time = W(this.currentTime))
    }
    play() {
        if (this.isStopped)
            return;
...
function ti() {
    ...
    Pe = !1,
    xe = !1,
    rt.forEach(t => t.complete(Se)),
    rt.clear()
}
function ei() {
    rt.forEach(t => {
        t.readKeyframes(),
        t.needsMeasurement && (Pe = !0)
    }
    )
}
function yo() {
...
class Ze {
    ...
    scheduleResolve() {
        ...
        this.isAsync ? (rt.add(this),
        xe || (xe = !0,
        V.read(ei),
        V.resolveKeyframes(ti))) : (this.readKeyframes(),
        this.complete())
    }
    readKeyframes() {
    ...
    cancel() {
        this.state === "scheduled" && (rt.delete(this),
        this.state = "pending")
    }
    resume() {
...
const xo = je( () => window.ScrollTimeline !== void 0)
  , Po = {};
function So(t, e) {
    const n = je(t);
    return () => Po[e] ?? n()
...
function si(t, e) {
    if (t)
        return typeof t == "function" ? ni() ? Zs(t, e) : "ease-out" : Ks(t) ? xt(t) : Array.isArray(t) ? t.map(n => si(n, e) || wn.easeOut) : wn[t]
}
function bo(t, e, n, {delay: s=0, duration: i=300, repeat: o=0, repeatType: r="loop", ease: a="easeOut", times: l}={}, c=void 0) {
    const u = {
        [e]: n
    };
    l && (u.offset = l);
...
function Ao({type: t, ...e}) {
    return ii(t) && ni() ? t.applyToOptions(e) : (e.duration ?? (e.duration = 300),
...
class wo extends Ye {
    constructor(e) {
        ...
        const c = Ao(e);
        this.animation = bo(n, s, i, c, o),
        c.autoplay === !1 && this.animation.pause(),
        this.animation.onfinish = () => {
            if (this.finishedTime = this.time,
            !o) {
                const u = Xe(i, this.options, a, this.speed);
                this.updateMotionValue ? this.updateMotionValue(u) : To(n, s, u),
    ...
    set time(e) {
        this.finishedTime = null,
        this.animation.currentTime = H(e)
    }
    get speed() {
    ...
    attachTimeline({timeline: e, observe: n}) {
        ...
        e && xo() ? (this.animation.timeline = e,
        $) : n(this)
    }
}
const ri = {
...
function Co(t) {
    typeof t.ease == "string" && Vo(t.ease) && (t.ease = ri[t.ease])
}
const Vn = 10;
class Mo extends wo {
    constructor(e) {
    ...
    updateMotionValue(e) {
        ...
        n.setWithVelocity(a.sample(l - Vn).value, a.sample(l).value, Vn),
        a.stop()
    }
}
const Cn = (t, e) => e === "zIndex" ? !1 : !!(typeof t == "number" || Array.isArray(t) || typeof t == "string" && (Z.test(t) || t === "0") && !t.startsWith("url("));
function Do(t) {
    const e = t[0];
    if (t.length === 1)
        return !0;
...
function Eo(t, e, n, s) {
    ...
    const o = t[t.length - 1]
      , r = Cn(i, e)
      , a = Cn(o, e);
    return !r || !a ? !1 : Do(t) || (n === "spring" || ii(n)) && s
}
function be(t) {
    t.duration = 0,
    t.type = "keyframes"
...
const Ro = new Set(["opacity", "clipPath", "filter", "transform"])
  , Lo = je( () => Object.hasOwnProperty.call(Element.prototype, "animate"));
function ko(t) {
    ...
    return Lo() && n && Ro.has(n) && (n !== "transform" || !c) && !l && !s && i !== "mirror" && o !== 0 && r !== "inertia"
}
const Fo = 40;
class Bo extends Ye {
    constructor({autoplay: e=!0, delay: n=0, type: s="keyframes", repeat: i=0, repeatDelay: o=0, repeatType: r="loop", keyframes: a, name: l, motionValue: c, element: u, ...h}) {
        ...
        this.keyframeResolver = new d(a, (m, v, y) => this.onKeyframesResolved(m, v, f, !y),l,c,u),
    ...
    onKeyframesResolved(e, n, s, i) {
        ...
        Eo(e, o, r, a) || ((X.instantAnimations || !l) && u?.(Xe(e, s, n)),
        e[0] = e[e.length - 1],
        be(s),
        s.repeat = 0);
        const f = {
            startTime: i ? this.resolvedAt ? this.resolvedAt - this.createdAt > Fo ? this.resolvedAt : this.createdAt : this.createdAt : void 0,
            finalKeyframe: n,
            ...s,
            keyframes: e
        }
...
function _o(t, e, n) {
    ...
    for (; s < t.length && !i; ) {
        const o = t[s];
        typeof o == "string" && !Ho.has(o) && Mt(o).values.length && (i = t[s]),
        s++
    }
    if (i && n)
        for (const o of e)
...
class zo extends Ze {
    ...
    readKeyframes() {
        ...
        if (r !== a)
            if (An(r) && An(a))
                ...
                it[s] && (this.needsMeasurement = !0)
    }
    resolveNoneKeyframes() {
        const {unresolvedKeyframes: e, name: n} = this
          , s = [];
        for (let i = 0; i < e.length; i++)
            (e[i] === null || No(e[i])) && s.push(i);
        s.length && _o(e, s, n)
    }
    measureInitialState() {
    ...
    measureEndState() {
        ...
        this.removedTransforms?.length && this.removedTransforms.forEach( ([a,l]) => {
            e.getValue(a).set(l)
        }
        ),
...
const {schedule: tn} = Ws(queueMicrotask, !1)
  , G = {
    x: !1,
    y: !1
};
...
function sa(t, e, n={}) {
    ...
    return s.forEach(a => {
        ...
        Yo(a) && (a.addEventListener("focus", c => na(c, i)),
...
const ua = new Set(["animate", "exit", "variants", "initial", "style", "values", "variants", "transition", "transformTemplate", "custom", "inherit", "onBeforeLayoutMeasure", "onAnimationStart", "onAnimationComplete", "onUpdate", "onDragStart", "onDrag", "onDragEnd", "onMeasureDragConstraints", "onDirectionLock", "onDragTransitionEnd", "_dragX", "_dragY", "onHoverStart", "onHoverEnd", "onViewportEnter", "onViewportLeave", "globalTapTarget", "ignoreStrict", "viewport"]);
function _t(t) {
    return t.startsWith("while") || t.startsWith("drag") && t !== "draggable" || t.startsWith("layout") || t.startsWith("onTap") || t.startsWith("onPan") || t.startsWith("onLayout") || ua.has(t)
}
let Ti = t => !_t(t);
function ca(t) {
...
function ha(t, e, n) {
    const s = {};
    for (const i in t)
        i === "values" && typeof t.values == "object" || (Ti(i) || n === !0 && _t(i) || !e && !_t(i) || t.draggable && i.startsWith("onDrag")) && (s[i] = t[i]);
    return s
}
...
const nn = ["animate", "whileInView", "whileFocus", "whileHover", "whileTap", "whileDrag", "exit"]
  , sn = ["initial", ...nn];
function qt(t) {
    return Yt(t.animate) || sn.some(e => Dt(t[e]))
}
function xi(t) {
...
function da(t) {
    const {initial: e, animate: n} = fa(t, S.useContext(Xt));
    return S.useMemo( () => ({
        initial: e,
        animate: n
    }), [Bn(e), Bn(n)])
...
function ma(t) {
    for (const e in t)
        Et[e] = t[e],
        We(e) && (Et[e].isCSSVariable = !0)
}
function Pi(t, {layout: e, layoutId: n}) {
    return vt.has(t) || t.startsWith("origin") || (e || n !== void 0) && (!!Et[t] || t === "opacity")
}
const pa = {
    x: "translateX",
    y: "translateY",
...
function rn(t, e, n) {
    ...
    if (e.transform || (r || n ? s.transform = ya(e, t.transform, n) : s.transform && (s.transform = "none")),
    a) {
...
function bi(t, {attrX: e, attrY: n, attrScale: s, pathLength: i, pathSpacing: o=1, pathOffset: r=0, ...a}, l, c, u) {
    if (rn(t, a, c),
    l) {
...
function Aa(t, e, n, s) {
    const i = S.useMemo( () => {
        const o = Ai();
        return bi(o, e, wi(s), t.transformTemplate, t.style),
        {
            ...o.attrs,
            style: {
                ...o.style
...
const wa = ["animate", "circle", "defs", "desc", "ellipse", "g", "image", "line", "filter", "marker", "mask", "metadata", "path", "pattern", "polygon", "polyline", "rect", "stop", "switch", "symbol", "svg", "text", "tspan", "use", "view"];
function an(t) {
    return typeof t != "string" || t.includes("-") ? !1 : !!(wa.indexOf(t) > -1 || /[A-Z]/u.test(t))
}
function Va(t, e, n, {latestValues: s}, i, o=!1) {
    const a = (an(t) ? Aa : xa)(e, s, i, t)
...
function un(t, e, n) {
    const {style: s} = t
      , i = {};
    for (const o in s)
        (F(s[o]) || e.style && F(e.style[o]) || Pi(o, t) || n?.getValue(o)?.liveStyle !== void 0) && (i[o] = s[o]);
    return i
}
const Da = Vi({
...
function Fa(t, e, n, s, i) {
    ...
    const u = c.current
      , h = S.useContext(Di);
    u && !u.projection && i && (u.type === "html" || u.type === "svg") && Ba(c.current, n, i, h);
    const f = S.useRef(!1);
...
function Ei(t) {
    if (t)
        return t.options.allowProjection !== !1 ? t.projection : Ei(t.parent)
}
function se(t, {forwardMotionProps: e=!1}={}, n, s) {
    ...
    function o(a, l) {
        ...
        if (!h && ke) {
            ...
            const m = ja(u);
            c = m.MeasureLayout,
            f.visualElement = Fa(t, d, u, s, m.ProjectionNode)
        }
        return or(Xt.Provider, {
            value: f,
            children: [c && f.visualElement ? Vs(c, {
                visualElement: f.visualElement,
                ...u
            }) : null, Va(t, a, La(d, f.visualElement, l), d, h, e)]
        })
    }
...
function Na(t, e) {
    ...
    const n = new Map
      ...
      , i = (o, r) => s(o, r);
    return new Proxy(i,{
        get: (o, r) => r === "create" ? s : (n.has(r) || n.set(r, se(r, void 0, t, e)),
        n.get(r))
    })
}
...
function Kn(t, e, n, s, i=.5) {
    const o = C(t.min, t.max, i);
    Ve(t, e, n, o, s)
}
function ht(t, e) {
    Kn(t.x, e.x, e.scaleX, e.scale, e.originX),
    Kn(t.y, e.y, e.scaleY, e.scale, e.originY)
}
function Fi(t, e) {
    return Ri(Ka(t.getBoundingClientRect(), e))
}
function $a(t, e, n) {
    const s = Fi(t, n)
      , {scroll: i} = e;
    return i && (ct(s.x, i.offset.x),
    ct(s.y, i.offset.y)),
    s
}
const Wn = () => ({
...
const Gn = ["AnimationStart", "AnimationComplete", "Update", "BeforeLayoutMeasure", "LayoutMeasure", "LayoutAnimationStart", "LayoutAnimationComplete"];
class za {
    ...
    update(e, n) {
        ...
        this.prevMotionValues = _a(this, this.scrapeMotionValuesFromProps(e, this.prevProps, this), this.prevMotionValues),
    ...
    readValue(e, n) {
        ...
        return s != null && (typeof s == "string" && (Ms(s) || Es(s)) ? s = parseFloat(s) : !oa(s) && Z.test(n) && (s = hi(e, n)),
    ...
    on(e, n) {
        return this.events[e] || (this.events[e] = new Ne),
        this.events[e].add(n)
    }
    notify(e, ...n) {
...
class Ya extends Ii {
    constructor() {
        super(...arguments),
        this.type = "html",
        this.renderInstance = Oi
    }
    readValueFromInstance(e, n) {
        if (vt.has(n))
            return this.projection?.isProjecting ? ve(n) : ho(e, n);
        {
            const s = Xa(e)
              , i = (We(n) ? s.getPropertyValue(n) : s[n]) || 0;
...
function qa(t, e, n, s) {
    ...
    for (const i in e.attrs)
        t.setAttribute(ji.has(i) ? i : cn(i), e.attrs[i])
}
class Za extends Ii {
    constructor() {
        super(...arguments),
...
const Ja = (t, e) => an(t) ? new Za(e) : new Ya(e,{
...
const rl = {
  ...
  , ul = (t, {keyframes: e}) => e.length > 2 ? al : vt.has(t) ? t.startsWith("scale") ? ol(e[1]) : rl : ll;
function cl({when: t, delay: e, delayChildren: n, staggerChildren: s, staggerDirection: i, repeat: o, repeatType: r, repeatDelay: a, from: l, elapsed: c, ...u}) {
...
const hn = (t, e, n, s={}, i, o) => r => {
    ...
    cl(a) || Object.assign(u, ul(t, u)),
    u.duration && (u.duration = H(u.duration)),
    u.repeatDelay && (u.repeatDelay = H(u.repeatDelay)),
    u.from !== void 0 && (u.keyframes[0] = u.from);
    let h = !1;
    if ((u.type === !1 || u.duration === 0 && !u.repeatDelay) && (be(u),
    u.delay === 0 && (h = !0)),
    (X.instantAnimations || X.skipAnimations) && (h = !0,
    be(u),
    u.delay = 0),
    u.allowFlatten = !a.type && !a.ease,
    h && !o && e.get() !== void 0) {
        const f = il(u.keyframes, a);
        if (f !== void 0) {
            V.update( () => {
                u.onUpdate(f),
                u.onComplete()
    ...
    return a.isSync ? new qe(u) : new Bo(u)
}
;
    ...
    for (const u in a) {
        ...
        if (window.MotionHandoffAnimation) {
            ...
            if (p) {
                ...
                T !== null && (d.startTime = T,
                v = !0)
            }
        }
        De(t, u),
        h.start(hn(u, h, f, t.shouldReduceMotion && ai.has(u) ? {
            type: !1
        } : d, t, v));
        const y = h.animation;
        y && l.push(y)
...
function vl(t) {
    ...
    function r(l) {
        ...
        for (let y = 0; y < gl; y++) {
            ...
            for (const L in ir) {
                ...
                if (d.hasOwnProperty(L))
                    continue;
                let at = !1;
                Me(N) && Me(Q) ? at = !Wi(N, Q) : at = N !== Q,
                at ? N != null ? dn(L) : f.add(L) : N !== void 0 && f.has(L) ? dn(L) : T.protectedKeys[L] = !0
            }
            T.prevProp = g,
        ...
        let v = !!h.length;
        return s && (c.initial === !1 || c.initial === c.animate) && !t.manuallyAnimateOnMount && (v = !1),
        s = !1,
...
class xl extends J {
    constructor(e) {
        super(e),
        e.animationState || (e.animationState = vl(e))
    }
...
const Al = t => e => en(e) && t(e, Bt(e));
function bt(t, e, n, s) {
    return Rt(t, e, Al(n), s)
}
const Gi = 1e-4
  , wl = 1 - Gi
  , Vl = 1 + Gi
...
function At(t, e, n, s) {
    _n(t.x, e.x, n.x, s ? s.originX : void 0),
    _n(t.y, e.y, n.y, s ? s.originY : void 0)
}
function zn(t, e, n) {
    t.min = n.min + e.min,
    t.max = t.min + B(e)
    ...
    constructor(e, n, {transformPagePoint: s, contextWindow: i=window, dragSnapToOrigin: o=!1, distanceThreshold: r=3}={}) {
        ...
        this.handlePointerUp = (f, d) => {
            ...
            !(this.lastMoveEvent && this.lastMoveEventInfo))
                return;
            const p = oe(f.type === "pointercancel" ? this.lastMoveEventInfo : re(d, this.transformPagePoint), this.history);
            this.startEvent && m && m(f, p),
            v && v(f, p)
        }
        ,
        !en(e))
        ...
        this.removeListeners = Lt(bt(this.contextWindow, "pointermove", this.handlePointerMove), bt(this.contextWindow, "pointerup", this.handlePointerUp), bt(this.contextWindow, "pointercancel", this.handlePointerUp))
    }
    updateHandlers(e) {
        this.handlers = e
    }
...
function Ol(t, e) {
    ...
    const s = B(t)
      , i = B(e);
    return i > s ? n = Vt(e.min, e.max - s, t.min) : s > i && (n = Vt(t.min, t.max - i, e.min)),
    z(0, 1, n)
}
function jl(t, e) {
    const n = {};
...
class Kl {
    ...
    resolveConstraints() {
        const {dragConstraints: e, dragElastic: n} = this.getProps()
          ...
          , i = this.constraints;
        e && ut(e) ? this.constraints || (this.constraints = this.resolveRefConstraints()) : e && s ? this.constraints = Bl(s.layoutBox, e) : this.constraints = !1,
        this.elastic = Nl(n),
        i !== this.constraints && s && this.constraints && !this.hasMutatedConstraints && K(o => {
            this.constraints !== !1 && this.getAxisMotionValue(o) && (this.constraints[o] = jl(s.layoutBox[o], this.constraints[o]))
        }
        )
    }
    ...
    startAxisValueAnimation(e, n) {
        ...
        return De(this.visualElement, e),
        s.start(hn(e, s, 0, n, this.visualElement, !1))
    }
    stopAnimation() {
    ...
    getProps() {
        const e = this.visualElement.getProps()
          , {drag: n=!1, dragDirectionLock: s=!1, dragPropagation: i=!1, dragConstraints: o=!1, dragElastic: r=Re, dragMomentum: a=!0} = e;
        return {
            ...e,
            drag: n,
            dragDirectionLock: s,
...
function Ql(t, e, n, s, i, o) {
    i ? (t.opacity = C(0, n.opacity ?? 1, tu(s)),
    t.opacityExit = C(e.opacity ?? 1, 0, eu(s))) : o && (t.opacity = C(e.opacity ?? 1, n.opacity ?? 1, s));
    for (let r = 0; r < Jl; r++) {
        ...
        l || (l = 0),
        c || (c = 0),
        l === 0 || c === 0 || is(l) === is(c) ? (t[a] = Math.max(C(ss(l), ss(c), s), 0),
        (_.test(c) || _.test(l)) && (t[a] += "%")) : t[a] = c
    }
...
function nu(t, e=0, n=1, s=.5, i, o=t, r=t) {
    ...
    t === o && (a -= e),
    t.min = ls(t.min, e, n, a, i),
    t.max = ls(t.max, e, n, a, i)
}
function us(t, e, [n,s,i], o, r) {
    nu(t, e[n], e[s], e[i], e.scale, o, r)
}
const su = ["x", "scaleX", "originX"]
  , iu = ["y", "scaleY", "originY"];
function cs(t, e, n, s) {
    us(t.x, e, su, n ? n.x : void 0, s ? s.x : void 0),
    us(t.y, e, iu, n ? n.y : void 0, s ? s.y : void 0)
}
function hs(t) {
...
function er({attachResizeListener: t, defaultParent: e, measureScroll: n, checkIsScrollRoot: s, resetTransform: i}) {
    return class {
        constructor(r={}, a=e?.()) {
            this.id = uu++,
            this.animationId = 0,
        ...
        addEventListener(r, a) {
            return this.eventHandlers.has(r) || this.eventHandlers.set(r, new Ne),
        ...
        mount(r) {
            ...
            t) {
                ...
                t(r, () => {
                    ...
                    u && u(),
                    u = Zl(f, 250),
                    Wt.hasAnimatedSinceResize && (Wt.hasAnimatedSinceResize = !1,
            ...
            this.options.animate !== !1 && c && (a || l) && this.addEventListener("didUpdate", ({delta: u, hasLayoutChanged: h, hasRelativeLayoutChanged: f, layout: d}) => {
                ...
                const m = this.options.transition || c.getDefaultTransition() || Su
                ...
                if (this.options.layoutRoot || this.resumeFrom || T || h && (p || !this.currentAnimation)) {
                    ...
                    (c.shouldReduceMotion || this.options.layoutRoot) && (g.delay = 0,
                    g.type = !1),
        ...
        willUpdate(r=!0) {
            ...
            if (window.MotionCancelOptimisedAnimation && !this.hasCheckedOptimisedAppear && tr(this),
        ...
        update() {
            ...
            this.nodes.forEach(hu)) : this.nodes.forEach(ys),
            this.clearAllSnapshots();
            const a = O.now();
        ...
        didUpdate() {
            ...
            tn.read(this.scheduleUpdate))
        }
        clearAllSnapshots() {
            this.nodes.forEach(mu),
            this.sharedNodes.forEach(Tu)
        }
        ...
        updateSnapshot() {
            ...
            this.snapshot && !B(this.snapshot.measuredBox.x) && !B(this.snapshot.measuredBox.y) && (this.snapshot = void 0))
        }
        updateLayout() {
        ...
        resetTransform() {
            ...
            r && this.instance && (a || et(this.latestValues) || u) && (i(this.instance, c),
            this.shouldResetTransform = !1,
            this.scheduleRender())
        }
        measure(r=!0) {
        ...
        removeElementScroll(r) {
            ...
            for (let l = 0; l < this.path.length; l++) {
                ...
                c !== this.root && u && h.layoutScroll && (u.wasRoot && U(a, r),
                ct(a.x, u.offset.x),
                ct(a.y, u.offset.y))
            }
            return a
        ...
        applyTransform(r, a=!1) {
            ...
            return et(this.latestValues) && ht(l, this.latestValues),
            l
        }
        removeTransform(r) {
            const a = D();
            ...
            for (let l = 0; l < this.path.length; l++) {
                ...
                const u = D()
                  , h = c.measurePageBox();
                U(u, h),
                cs(a, c.latestValues, c.snapshot ? c.snapshot.layoutBox : void 0, u)
            }
            return et(this.latestValues) && cs(a, this.latestValues),
            a
        }
        setTargetDelta(r) {
            this.targetDelta = r,
        ...
        resolveTargetDelta(r=!1) {
            ...
            if (!(!this.layout || !(u || h))) {
                ...
                if (!(!this.relativeTarget && !this.targetDelta) && (this.target || (this.target = D(),
                this.targetWithTransforms = D()),
                this.relativeTarget && this.relativeTargetOrigin && this.relativeParent && this.relativeParent.target ? (this.forceRelativeParentToResolveTarget(),
                El(this.target, this.relativeTarget, this.relativeParent.target)) : this.targetDelta ? (this.resumingFrom ? this.target = this.applyTransform(this.layout.layoutBox) : U(this.target, this.layout.layoutBox),
                ki(this.target, this.targetDelta)) : U(this.target, this.layout.layoutBox),
        ...
        getClosestProjectingParent() {
            if (!(!this.parent || we(this.parent.latestValues) || Li(this.parent.latestValues)))
        ...
        calcProjection() {
            ...
            let l = !0;
            if ((this.isProjectionDirty || this.parent?.isProjectionDirty) && (l = !1),
            ...
            !this.projectionDelta || !this.prevProjectionDelta ? this.createProjectionDeltas() : (as(this.prevProjectionDelta.x, this.projectionDelta.x),
            as(this.prevProjectionDelta.y, this.projectionDelta.y)),
            At(this.projectionDelta, this.layoutCorrected, d, this.latestValues),
            (this.treeScale.x !== h || this.treeScale.y !== f || !ps(this.projectionDelta.x, this.prevProjectionDelta.x) || !ps(this.projectionDelta.y, this.prevProjectionDelta.y)) && (this.hasProjected = !0,
            this.scheduleRender(),
        ...
        setAnimationOrigin(r, a=!1) {
            ...
            const f = D()
              ...
              , T = !!(v && !p && this.options.crossfade === !0 && !this.path.some(Pu));
            this.animationProgress = 0;
            let g;
            this.mixTargetDelta = A => {
                ...
                this.relativeTarget && this.relativeTargetOrigin && this.layout && this.relativeParent && this.relativeParent.layout && (wt(f, this.layout.layoutBox, this.relativeParent.layout.layoutBox),
                xu(this.relativeTarget, this.relativeTargetOrigin, f, P),
                g && ru(this.relativeTarget, g) && (this.isProjectionDirty = !1),
                g || (g = D()),
                U(g, this.relativeTarget)),
                v && (this.animationValues = u,
                Ql(u, c, this.latestValues, P, T, p)),
                this.root.scheduleUpdateProjection(),
                this.scheduleRender(),
        ...
        startAnimation(r) {
            ...
            this.pendingAnimation && (q(this.pendingAnimation),
        ...
        finishAnimation() {
            this.currentAnimation && (this.mixTargetDelta && this.mixTargetDelta(lu),
            this.currentAnimation.stop()),
            this.completeAnimation()
        }
        ...
        registerSharedNode(r, a) {
            this.sharedNodes.has(r) || this.sharedNodes.set(r, new ou),
        ...
        applyProjectionStyles(r, a) {
            ...
            if (!this.projectionDelta || !this.layout || !c.target) {
                ...
                r.pointerEvents = Kt(a?.pointerEvents) || ""),
                this.hasProjected && !et(this.latestValues) && (r.transform = l ? l({}, "") : "none",
                this.hasProjected = !1);
                return
            }
            r.visibility = "";
            ...
            let h = au(this.projectionDeltaWithTransform, this.treeScale, u);
            l && (h = l(u, h)),
            r.transform = h;
        ...
        if (!t.resumeFrom) {
            ...
            if (u && !u.resumeFrom) {
                ...
                if (h && f) {
                    ...
                    wt(m, n, f.layoutBox),
                    Qi(d, m) || (c = !0),
                    u.options.layoutRoot && (t.relativeTarget = m,
...
const Su = {
  ...
  , Ss = Ps("applewebkit/") && !Ps("chrome/") ? Math.round : $;
function bs(t) {
    t.min = Ss(t.min),
    t.max = Ss(t.max)
}
...
function nr(t, e, n) {
    return t === "position" || t === "preserve-aspect" && !Dl(ms(e), ms(n), .2)
}
function Au(t) {
...
class Cu extends J {
    mount() {
        ...
        e && (this.unmount = Qo(e, (n, s) => (As(this.node, s, "Start"),
        i => As(this.node, i, "End"))))
    }
    unmount() {}
}
class Mu extends J {
    ...
    mount() {
        this.unmount = Lt(Rt(this.node.current, "focus", () => this.onFocus()), Rt(this.node.current, "blur", () => this.onBlur()))
    }
    unmount() {}
}
function ws(t, e, n) {
...
class Du extends J {
    mount() {
        const {current: e} = this.node;
        e && (this.unmount = sa(e, (n, s) => (ws(this.node, s, "Start"),
...
function Lu({root: t, ...e}) {
    ...
    const s = he.get(n)
      , i = JSON.stringify(e);
    return s[i] || (s[i] = new IntersectionObserver(Ru,{
        root: t,
        ...e
    })),
    s[i]
...
class Bu extends J {
    ...
    startObserver() {
        ...
        const {viewport: e={}} = this.node.getProps()
          ...
          , r = {
            ...
            rootMargin: s,
            threshold: typeof i == "number" ? i : Fu[i]
        }
          , a = l => {
    ...
    update() {
        ...
        ["amount", "margin", "root"].some(Iu(e, n)) && this.startObserver()
    }
    unmount() {}
}
function Iu({viewport: t={}}, {viewport: e={}}={}) {
    return n => t[n] !== e[n]
}
const Ou = {
    inView: {
  ...
  , $u = Na(Nu, Ja);
export {Cs as L, yi as M, Fe as P, aa as a, lr as b, Yo as i, $u as m, ar as u};
