import {c as oe} from "./clsx-B-dksMZM.js";
const B = "-"
  , ne = e => {
    const r = le(e)
  ...
  , be = /\s+/
  , ge = (e, r) => {
    const {parseClassName: t, getClassGroupId: o, getConflictingClassGroupIds: i} = r
      , n = []
      , a = e.trim().split(be);
    let s = "";
...
function Le(e, r="", t={}) {
    for (const o in e)
        if (Object.prototype.hasOwnProperty.call(e, o)) {
            const i = r ? r + "_" + o : o;
            typeof e[o] == "object" && e[o] !== null && !Array.isArray(e[o]) ? Le(e[o], i, t) : t[i] = e[o]
        }
    return t
}
export {We as c, Le as f, Ve as s};
